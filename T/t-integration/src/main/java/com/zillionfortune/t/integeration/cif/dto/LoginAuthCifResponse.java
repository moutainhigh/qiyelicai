 ...
 * @since JDK 1.7
 */
public class LoginAuthCifResponse extends BaseResponse {
	...
	public LoginAuthCifResponse(String respCode) {
		super(respCode);
	}
	
	public LoginAuthCifResponse(String respCode, String resultCode, String resultMsg) {
		super(respCode, resultCode, resultMsg);
	}

	public LoginAuthCifResponse() {
		super();
	}

	public LoginAuthCifResponse(String respCode, String resultMsg) {
