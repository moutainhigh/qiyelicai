...
import com.zillionfortune.t.common.exception.PaycoreException;
...
public class HttpClientUtil {
     ...
     * @param isEncoder 用于指明请求数据是否需要UTF-8编码,true为需要
     */
    public static String sendJsonPostRequest(String reqURL, String sendData, boolean isEncoder) {

        return sendJsonPostRequest(reqURL, sendData, isEncoder, null, null);
    }
     ...
     * @return 远程主机响应正文
     */
    public static String sendJsonPostRequest(String reqURL, String sendData, boolean isEncoder, String encodeCharset,
                                         String decodeCharset) {
     ...
     * @return
     */
    public static String doJsonPost(String reqURL,String json){
...
//    	//URL
//       	String url="http://localhost:8080/cif/enterpriseuserloginservice/login.html";
//        //请求参数
//  		Map<String, String> params = new HashMap<String, String>();
//  		params.put("customerNo", "100002");
//  		params.put("loginName", "kaiyun");
//  		params.put("password", "123456");
//  		params.put("loginSource", "1");
//  		
//       	String json = null;
//		try {
//			json = sendPostRequest(url, params);
//		} catch (Exception e) {
//			e.printStackTrace();
//		}
...
//    	//URL
//       	String url="http://192.168.0.73:8080/product/productService/productListQuery.html";
//        //请求参数
//  		Map<String, String> params = new HashMap<String, String>();
//  		params.put("productLineId", "");
//  		
//       	String json = null;
//		try {
//			json = sendPostRequest(url, params);
...
//		System.out.println(json);
    	...
    	//URL
       	String url="http://localhost:8080/t-web/enterpriseuserloginservice/checkLoginCode.json";
        //请求参数
  		Map<String, String> params = new HashMap<String, String>();
  		params.put("codeAuth", "4");
  		params.put("verifyCode", "4");
